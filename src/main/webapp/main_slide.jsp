...
.section .slide-control .left {
	left: 30px;
	background: url('mainimg/left.png') center center/100% no-repeat;
}

.section .slide-control .right {
	right: 30px;
	background: url('mainimg/right.png') center center/100% no-repeat;
}
...
<body>
	<div class="section">
		...
		<div class="slidewrap">
			<ul class="slidelist">
				<li><a> <img src="mainimg/slide01.jpg">
				</a></li>
				<li><a> <img src="mainimg/slide02.jpg">
				</a></li>
				<li><a> <img src="mainimg/slide03.jpg">
				</a></li>
			</ul>
